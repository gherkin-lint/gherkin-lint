...
const RulesProvider = require('../src/rules-provider.js');
...
describe('Rule Parser', function() {
  context('When there are rules enabled and disabled', function() {
    it('return the list of enabled rules', function() {
      const rulesOrErrors = new RulesParser(new RulesProvider().provide()).parse({
  ...
  describe('Verification fails when', function() {
    it('a non existing rule', function() {
      const rulesOrErrors = new RulesParser(new RulesProvider().provide()).parse({'fake-rule': 'on'});
    ...
    it('first item is not "on" or "off"', function() {
      const rulesOrErrors = new RulesParser(new RulesProvider().provide())
